...
public class Pokemon implements IPokemon {
    ...
    public Pokemon evolve() {
        ...
        // 기존 객체 참조 삭제
        // 진화된 객체 생성 및 리턴
        String evolveTo = PokeDex.evolveToPokemon.get(this.getPokemonName());
        if (evolveTo == null) {
            System.out.println("Pokemon " + this.getPokemonName() + " cannot evolve");
            return this;
        }
        System.out.println(this.pokemonName + " is evolved to " + PokeDex.evolveToPokemon.get(this.getPokemonName()) + "!");
        return PokeDex.evolvedPokemonByName.get(evolveTo).fromDex();
